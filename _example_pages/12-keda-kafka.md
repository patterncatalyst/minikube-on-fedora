...
**Source:** [`examples/12-keda-kafka/`](https://github.com/patterncatalyst/minikube-on-fedora/tree/main/examples/12-keda-kafka) &middot; [← Back to examples index]({{ "/docs/16-examples/" | relative_url }})
